...
using ZbW.Testing.Dms.Client.UnitTests.StubFactory;

namespace ZbW.Testing.Dms.Client.UnitTests.Services.Impl
{
  [TestFixture]
  public class FileSystemServiceTests
  {
    ...
    public void AddFile_GenerateNewGuid_ReturnTrue()
    {
      ...
      A.CallTo(() => directoryServiceStub.GetExtension(@"C:\Temp\sourcePath\test.pdf")).Returns(".pdf");
    ...
    public void AddFile_GetExtension_ReturnTrue()
    {
      ...
      //assert
      A.CallTo(() => directoryServiceStub.GetExtension(@"C:\Temp\sourcePath\test.pdf")).MustHaveHappened();
    ...
    public void AddFile_CheckContentMetadata_ReturnTrue()
    {
      ...
      //assert
      Assert.AreEqual(@"C:\Temp\sourcePath\test.pdf", metadataItemStub.OrginalPath);
    ...
    public void LoadMetaData_GetAllFiles_ReturnTrue()
    {
      ...
      var directoryServiceStub = A.Fake<IDirectoryService>();
      A.CallTo(() => directoryServiceStub.GetSubFolder(@"C:\Temp\sourcePath\test.pdf")).Returns(directoryList);
